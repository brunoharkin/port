                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        rows={5}
                        className={`input-animated ${formData.message ? 'filled' : ''} w-full px-4 py-3 bg-gray-800/50 border ${errors.message ? 'border-red-500' : 'border-gray-700'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00f0ff]/50 focus:border-transparent transition-all resize-none text-base sm:text-lg`}
                        placeholder="Descreva seu desafio, ideia ou objetivo. Vamos juntos além do comum!"
                      ></textarea>
                      {errors.message && (
                        <p className="mt-1 text-red-500 text-sm" role="alert">{errors.message}</p>
                      )}
                    </div>
  ...
  return (
    <div>
      ...
      <input
        ...
        value={value}
        onChange={onChange}
        className={`input-animated ${value ? 'filled' : ''} w-full px-4 py-3 bg-gray-800/50 border ${error ? 'border-red-500' : 'border-gray-700'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00f0ff]/50 focus:border-transparent transition-all`}
      />
      {error && (
